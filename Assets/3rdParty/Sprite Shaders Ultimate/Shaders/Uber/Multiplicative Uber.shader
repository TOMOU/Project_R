	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 texCoord83_g4013 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g4013 = texCoord83_g4013;
				float2 appendResult72_g4013 = (float2(( _SquishStretch * ( break77_g4013.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g4013.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH2_ON
				float2 staticSwitch198 = ( appendResult72_g4013 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g4015 = staticSwitch198;
				...
				float temp_output_8_0_g4015 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g4015 = ( ( sin( ( temp_output_8_0_g4015 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g4015 );
				#else
				float2 staticSwitch4_g4015 = temp_output_2_0_g4015;
				#endif
				float temp_output_30_0_g4017 = temp_output_8_0_g4015;
				float3 rotatedValue21_g4017 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g4017 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g4015 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g4017 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g4017).xy ) + staticSwitch4_g4015 );
				#else
				float2 staticSwitch6_g4015 = staticSwitch4_g4015;
				#endif
				float2 temp_output_250_0 = staticSwitch6_g4015;
				...
				float2 temp_output_27_0_g3884 = shaderPosition235;
				float clampResult3_g3884 = clamp( ( ( _FullFade - ( distance( _UberPosition , temp_output_27_0_g3884 ) + ( tex2Dlod( _UberNoiseTexture, float4( ( temp_output_27_0_g3884 * _UberNoiseScale ), 0, 0.0) ).r * _UberNoiseFactor ) ) ) / max( _UberWidth , 0.001 ) ) , 0.0 , 1.0 );
				...
				float staticSwitch139 = clampResult3_g3884;
				#else
				float staticSwitch139 = _FullFade;
				#endif
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float2 temp_output_27_0_g3884 = shaderPosition235;
				float clampResult3_g3884 = clamp( ( ( _FullFade - ( distance( _UberPosition , temp_output_27_0_g3884 ) + ( tex2D( _UberNoiseTexture, ( temp_output_27_0_g3884 * _UberNoiseScale ) ).r * _UberNoiseFactor ) ) ) / max( _UberWidth , 0.001 ) ) , 0.0 , 1.0 );
				#if defined(_UBERFADING_NONE)
				float staticSwitch139 = _FullFade;
				#elif defined(_UBERFADING_FULL)
				float staticSwitch139 = _FullFade;
				...
				float3 rotatedValue136_g3993 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g3993 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				...
				float3 rotatedValue136_g3995 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g3995 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				...
				#endif
				float4 temp_output_1_0_g4006 = staticSwitch13_g3990;
				float4 break2_g4008 = temp_output_1_0_g4006;
				float temp_output_9_0_g4007 = max( _AddColorContrast , 0.0 );
				float saferPower7_g4007 = max( ( ( ( break2_g4008.x + break2_g4008.y + break2_g4008.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4007 ) , 0.0 ) ) ) , 0.0001 );
				float4 appendResult6_g4006 = (float4(( ( (_AddColorColor).rgb * pow( saferPower7_g4007 , temp_output_9_0_g4007 ) * _AddColorFade ) + (temp_output_1_0_g4006).rgb ) , temp_output_1_0_g4006.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g4005 = appendResult6_g4006;
				#else
				float4 staticSwitch5_g4005 = staticSwitch13_g3990;
				#endif
				float4 temp_output_1_0_g4009 = staticSwitch5_g4005;
				float saferPower11_g4009 = max( ( 1.0 - temp_output_1_0_g4009.a ) , 0.0001 );
				float3 lerpResult4_g4009 = lerp( (temp_output_1_0_g4009).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g4009 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g4009.a ) ));
				float4 appendResult13_g4009 = (float4(lerpResult4_g4009 , temp_output_1_0_g4009.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g4005 = appendResult13_g4009;
				#else
				float4 staticSwitch11_g4005 = staticSwitch5_g4005;
				#endif
				float4 temp_output_1_0_g4010 = staticSwitch11_g4005;
				float4 break2_g4011 = temp_output_1_0_g4010;
				float temp_output_9_0_g4012 = max( _StrongTintContrast , 0.0 );
				float saferPower7_g4012 = max( ( ( ( break2_g4011.x + break2_g4011.y + break2_g4011.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4012 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult7_g4010 = lerp( (temp_output_1_0_g4010).rgb , ( pow( saferPower7_g4012 , temp_output_9_0_g4012 ) * (_StrongTintTint).rgb ) , _StrongTintFade);
				float4 appendResult9_g4010 = (float4(lerpResult7_g4010 , (temp_output_1_0_g4010).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g4005 = appendResult9_g4010;
				#else
				float4 staticSwitch7_g4005 = staticSwitch11_g4005;
				#endif
				...
				float4 temp_output_119_0 = ( staticSwitch7_g4005 * customVertexTint193 );
				...
				float4 staticSwitch143 = temp_output_119_0;
				#endif
				float4 temp_output_5_0_g4018 = staticSwitch143;
				float3 lerpResult2_g4018 = lerp( float3( 1,1,1 ) , (temp_output_5_0_g4018).rgb , temp_output_5_0_g4018.a);
				float4 appendResult3_g4018 = (float4(lerpResult2_g4018 , 1.0));
				
				fixed4 c = appendResult3_g4018;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18900
376;71;1414;737;-3497.514;-1238.872;1.956889;True;True
...
Node;AmplifyShaderEditor.FunctionNode;231;4899.456,2440.854;Inherit;False;_UberSpreadFade;-1;;3884;777ca8ab10170fb48b24b7cd1c44f075;0;7;27;FLOAT2;0,0;False;22;FLOAT;0;False;18;SAMPLER2D;0;False;25;FLOAT2;0,0;False;23;FLOAT2;0,0;False;21;FLOAT;0;False;26;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;166;;3887;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;257;3382.41,-2373.518;Inherit;False;_UberTransformUV;354;;3889;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;120;-737.796,35.8288;Inherit;False;_UberCustomAlpha;433;;3901;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;COLOR;12;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;240;-683.451,-246.0232;Inherit;False;237;shaderTime;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;418;;3906;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;241;-136.8644,-329.1863;Inherit;False;_UberColor;39;;3910;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-37.83691,-91.99512;Inherit;False;182;hologramFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;140;;3945;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;160;;3948;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;245;1656.25,-345.9998;Inherit;False;_UberEffect;171;;3952;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;277;;3990;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;117;4244.284,-85.79267;Inherit;False;_UberColorFinal;22;;4005;6ac57aba23ea6404ba71b6806ea93971;0;1;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;413;;4013;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4547.692,143.2021;Inherit;False;TintVertex;-1;;4014;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;391;;4015;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;260;5449.317,103.1707;Inherit;False;_MultiplicativeAlpha;-1;;4018;8b208be8b9c908d4fa87d2ed7f06e0d8;0;1;5;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=B5D839D357496B6B72B1D35784B71D49AB044117