	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 texCoord83_g3990 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g3990 = texCoord83_g3990;
				float2 appendResult72_g3990 = (float2(( _SquishStretch * ( break77_g3990.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g3990.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH2_ON
				float2 staticSwitch198 = ( appendResult72_g3990 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g4014 = staticSwitch198;
				...
				float temp_output_8_0_g4014 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g4014 = ( ( sin( ( temp_output_8_0_g4014 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g4014 );
				#else
				float2 staticSwitch4_g4014 = temp_output_2_0_g4014;
				#endif
				float temp_output_30_0_g4016 = temp_output_8_0_g4014;
				float3 rotatedValue21_g4016 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g4016 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g4014 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g4016 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g4016).xy ) + staticSwitch4_g4014 );
				#else
				float2 staticSwitch6_g4014 = staticSwitch4_g4014;
				#endif
				float2 temp_output_250_0 = staticSwitch6_g4014;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				#endif
				float4 temp_output_1_0_g4007 = staticSwitch13_g3991;
				...
				#else
				float4 staticSwitch5_g4006 = staticSwitch13_g3991;
				#endif
...
/*ASEBEGIN
Version=18900
376;71;1414;737;-3325.351;-1324.303;1.945626;True;True
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;413;;3990;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;277;;3991;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;117;4244.284,-85.79267;Inherit;False;_UberColorFinal;22;;4006;6ac57aba23ea6404ba71b6806ea93971;0;1;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;391;;4014;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=1941127F2B6DB6D93EA72B66C33824761B8A3752