	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 texCoord83_g4003 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g4003 = texCoord83_g4003;
				float2 appendResult72_g4003 = (float2(( _SquishStretch * ( break77_g4003.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g4003.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH2_ON
				float2 staticSwitch198 = ( appendResult72_g4003 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g4013 = staticSwitch198;
				...
				float temp_output_8_0_g4013 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g4013 = ( ( sin( ( temp_output_8_0_g4013 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g4013 );
				#else
				float2 staticSwitch4_g4013 = temp_output_2_0_g4013;
				#endif
				float temp_output_30_0_g4015 = temp_output_8_0_g4013;
				float3 rotatedValue21_g4015 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g4015 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g4013 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g4015 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g4015).xy ) + staticSwitch4_g4013 );
				#else
				float2 staticSwitch6_g4013 = staticSwitch4_g4013;
				#endif
				float2 temp_output_250_0 = staticSwitch6_g4013;
				...
				float temp_output_4_0_g3882 = max( _UberWidth , 0.001 );
				...
				float clampResult14_g3882 = clamp( ( ( ( _FullFade * ( 1.0 + temp_output_4_0_g3882 ) ) - tex2Dlod( _UberNoiseTexture, float4( ( shaderPosition235 * _UberNoiseScale ), 0, 0.0) ).r ) / temp_output_4_0_g3882 ) , 0.0 , 1.0 );
				float2 temp_output_27_0_g3880 = shaderPosition235;
				float clampResult3_g3880 = clamp( ( ( _FullFade - ( distance( _UberPosition , temp_output_27_0_g3880 ) + ( tex2Dlod( _UberNoiseTexture, float4( ( temp_output_27_0_g3880 * _UberNoiseScale ), 0, 0.0) ).r * _UberNoiseFactor ) ) ) / max( _UberWidth , 0.001 ) ) , 0.0 , 1.0 );
				...
				float staticSwitch139 = clampResult14_g3882;
				#elif defined(_UBERFADING_SPREAD)
				float staticSwitch139 = clampResult3_g3880;
				#else
				float staticSwitch139 = _FullFade;
				#endif
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float x101_g3863 = ( ( transform62_g3863.x + ( _Time.y * WindNoiseSpeed ) ) * WindNoiseScale );
				...
				#endif
				float2 temp_output_1_0_g3887 = staticSwitch62;
				float temp_output_25_0_g3887 = shaderTime237;
				float2 lerpResult21_g3888 = lerp( _UVDistortFrom , _UVDistortTo , tex2D( _UberNoiseTexture, ( ( shaderPosition235 + ( _UVDistortSpeed * temp_output_25_0_g3887 ) ) * _UVDistortNoiseScale ) ).r);
				float2 appendResult2_g3890 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 uv_UVDistortShaderMask = IN.texcoord.xy * _UVDistortShaderMask_ST.xy + _UVDistortShaderMask_ST.zw;
				float4 tex2DNode3_g3891 = tex2D( _UVDistortShaderMask, uv_UVDistortShaderMask );
				#ifdef _ENABLEUVDISTORT_ON
				float2 staticSwitch5_g3887 = ( temp_output_1_0_g3887 + ( lerpResult21_g3888 * ( 100.0 / appendResult2_g3890 ) * ( _UVDistortFade * ( tex2DNode3_g3891.r * tex2DNode3_g3891.a ) ) ) );
				#else
				float2 staticSwitch5_g3887 = temp_output_1_0_g3887;
				#endif
				float2 temp_output_1_0_g3892 = staticSwitch5_g3887;
				#ifdef _ENABLESQUEEZE_ON
				float2 staticSwitch7_g3887 = ( temp_output_1_0_g3892 + ( ( temp_output_1_0_g3892 - _SqueezeCenter ) * pow( distance( temp_output_1_0_g3892 , _SqueezeCenter ) , _SqueezePower ) * _SqueezeScale * _SqueezeFade ) );
				#else
				float2 staticSwitch7_g3887 = staticSwitch5_g3887;
				#endif
				float3 rotatedValue36_g3893 = RotateAroundAxis( float3( _SineRotatePivot ,  0.0 ), float3( staticSwitch7_g3887 ,  0.0 ), float3( 0,0,1 ), ( sin( ( temp_output_25_0_g3887 * _SineRotateFrequency ) ) * ( ( _SineRotateAngle / 360.0 ) * UNITY_PI ) * _SineRotateFade ) );
				#ifdef _ENABLESINEROTATE_ON
				float2 staticSwitch9_g3887 = (rotatedValue36_g3893).xy;
				#else
				float2 staticSwitch9_g3887 = staticSwitch7_g3887;
				#endif
				float3 rotatedValue8_g3894 = RotateAroundAxis( float3( _UVRotatePivot ,  0.0 ), float3( staticSwitch9_g3887 ,  0.0 ), float3( 0,0,1 ), ( temp_output_25_0_g3887 * _UVRotateSpeed * UNITY_PI ) );
				#ifdef _ENABLEUVROTATE_ON
				float2 staticSwitch16_g3887 = (rotatedValue8_g3894).xy;
				#else
				float2 staticSwitch16_g3887 = staticSwitch9_g3887;
				#endif
				#ifdef _ENABLEUVSCROLL_ON
				float2 staticSwitch14_g3887 = ( ( ( _UVScrollSpeed * temp_output_25_0_g3887 ) + staticSwitch16_g3887 ) % float2( 1,1 ) );
				#else
				float2 staticSwitch14_g3887 = staticSwitch16_g3887;
				#endif
				float2 appendResult2_g3897 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 MultFactor30_g3896 = ( _PixelatePixelDensity * ( float2( 1,1 ) / ( 100.0 / appendResult2_g3897 ) ) * ( 1.0 / max( _PixelateFade , 0.0001 ) ) );
				#ifdef _ENABLEPIXELATE_ON
				float2 staticSwitch4_g3887 = ( round( ( MultFactor30_g3896 * staticSwitch14_g3887 ) ) / MultFactor30_g3896 );
				#else
				float2 staticSwitch4_g3887 = staticSwitch14_g3887;
				#endif
				#ifdef _ENABLEUVSCALE_ON
				float2 staticSwitch24_g3887 = ( ( ( staticSwitch4_g3887 - _UVScalePivot ) / _UVScaleScale ) + _UVScalePivot );
				#else
				float2 staticSwitch24_g3887 = staticSwitch4_g3887;
				#endif
				float2 temp_output_257_0 = staticSwitch24_g3887;
				float2 texCoord131 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_UberMask = IN.texcoord.xy * _UberMask_ST.xy + _UberMask_ST.zw;
				float4 tex2DNode3_g3884 = tex2D( _UberMask, uv_UberMask );
				float temp_output_4_0_g3882 = max( _UberWidth , 0.001 );
				float clampResult14_g3882 = clamp( ( ( ( _FullFade * ( 1.0 + temp_output_4_0_g3882 ) ) - tex2D( _UberNoiseTexture, ( shaderPosition235 * _UberNoiseScale ) ).r ) / temp_output_4_0_g3882 ) , 0.0 , 1.0 );
				float2 temp_output_27_0_g3880 = shaderPosition235;
				float clampResult3_g3880 = clamp( ( ( _FullFade - ( distance( _UberPosition , temp_output_27_0_g3880 ) + ( tex2D( _UberNoiseTexture, ( temp_output_27_0_g3880 * _UberNoiseScale ) ).r * _UberNoiseFactor ) ) ) / max( _UberWidth , 0.001 ) ) , 0.0 , 1.0 );
				#if defined(_UBERFADING_NONE)
				float staticSwitch139 = _FullFade;
				#elif defined(_UBERFADING_FULL)
				float staticSwitch139 = _FullFade;
				...
				float4 temp_output_1_0_g3899 = originalColor191;
				float4 temp_output_1_0_g3902 = temp_output_1_0_g3899;
				float2 temp_output_7_0_g3899 = finalUV146;
				float2 temp_output_43_0_g3902 = temp_output_7_0_g3899;
				float2 temp_cast_11 = (_SmokeNoiseScale).xx;
				float clampResult28_g3902 = clamp( ( ( ( tex2D( _UberNoiseTexture, ( ( ( IN.color.r * (( _SmokeVertexSeed )?( 5.0 ):( 0.0 )) ) + temp_output_43_0_g3902 ) * temp_cast_11 ) ).r - 1.0 ) * _SmokeNoiseFactor ) + ( ( ( IN.color.a / 2.5 ) - distance( temp_output_43_0_g3902 , float2( 0.5,0.5 ) ) ) * 2.5 * _SmokeSmoothness ) ) , 0.0 , 1.0 );
				float3 lerpResult34_g3902 = lerp( ( (temp_output_1_0_g3902).rgb * (IN.color).rgb ) , float3( 0,0,0 ) , ( ( 1.0 - clampResult28_g3902 ) * _SmokeDarkEdge ));
				float4 appendResult31_g3902 = (float4(lerpResult34_g3902 , ( clampResult28_g3902 * _SmokeAlpha * temp_output_1_0_g3902.a )));
				#ifdef _ENABLESMOKE_ON
				float4 staticSwitch2_g3899 = appendResult31_g3902;
				#else
				float4 staticSwitch2_g3899 = temp_output_1_0_g3899;
				#endif
				float4 temp_output_1_0_g3900 = staticSwitch2_g3899;
				float2 temp_output_57_0_g3900 = temp_output_7_0_g3899;
				float4 tex2DNode3_g3900 = tex2D( _CustomFadeFadeMask, temp_output_57_0_g3900 );
				float clampResult37_g3900 = clamp( ( ( ( IN.color.a * 2.0 ) - 1.0 ) + ( tex2DNode3_g3900.r + ( tex2D( _UberNoiseTexture, ( temp_output_57_0_g3900 * _CustomFadeNoiseScale ) ).r * _CustomFadeNoiseFactor ) ) ) , 0.0 , 1.0 );
				float4 appendResult13_g3900 = (float4(( float4( (IN.color).rgb , 0.0 ) * temp_output_1_0_g3900 ).rgb , ( temp_output_1_0_g3900.a * pow( clampResult37_g3900 , ( _CustomFadeSmoothness / max( tex2DNode3_g3900.r , 0.05 ) ) ) * _CustomFadeAlpha )));
				#ifdef _ENABLECUSTOMFADE_ON
				float4 staticSwitch3_g3899 = appendResult13_g3900;
				#else
				float4 staticSwitch3_g3899 = staticSwitch2_g3899;
				#endif
				float4 temp_output_1_0_g3904 = staticSwitch3_g3899;
				float4 temp_output_1_0_g3905 = temp_output_1_0_g3904;
				float2 appendResult4_g3905 = (float2(ase_worldPos.x , ase_worldPos.y));
				float2 temp_output_44_0_g3905 = ( appendResult4_g3905 * _CheckerboardTiling * 0.5 );
				float2 break12_g3905 = step( ( ceil( temp_output_44_0_g3905 ) - temp_output_44_0_g3905 ) , float2( 0.5,0.5 ) );
				float3 temp_cast_16 = (( _CheckerboardDarken * abs( ( -break12_g3905.x + break12_g3905.y ) ) )).xxx;
				float4 appendResult42_g3905 = (float4(( (temp_output_1_0_g3905).rgb - temp_cast_16 ) , temp_output_1_0_g3905.a));
				#ifdef _ENABLECHECKERBOARD_ON
				float4 staticSwitch2_g3904 = appendResult42_g3905;
				#else
				float4 staticSwitch2_g3904 = temp_output_1_0_g3904;
				#endif
				float2 temp_output_75_0_g3906 = finalUV146;
				float saferPower57_g3906 = max( max( ( temp_output_75_0_g3906.y - 0.2 ) , 0.0 ) , 0.0001 );
				float temp_output_47_0_g3906 = max( _FlameRadius , 0.01 );
				float clampResult70_g3906 = clamp( ( ( ( tex2D( _UberNoiseTexture, ( ( ( shaderTime237 * _FlameSpeed ) + temp_output_75_0_g3906 ) * _FlameNoiseScale ) ).r * pow( saferPower57_g3906 , _FlameNoiseHeightFactor ) * _FlameNoiseFactor ) + ( ( temp_output_47_0_g3906 - distance( temp_output_75_0_g3906 , float2( 0.5,0.4 ) ) ) / temp_output_47_0_g3906 ) ) * _FlameSmooth ) , 0.0 , 1.0 );
				float temp_output_63_0_g3906 = ( clampResult70_g3906 * _FlameBrightness );
				float4 appendResult31_g3906 = (float4(temp_output_63_0_g3906 , temp_output_63_0_g3906 , temp_output_63_0_g3906 , clampResult70_g3906));
				#ifdef _ENABLEFLAME_ON
				float4 staticSwitch6_g3904 = ( appendResult31_g3906 * staticSwitch2_g3904 );
				#else
				float4 staticSwitch6_g3904 = staticSwitch2_g3904;
				#endif
				float4 temp_output_3_0_g3908 = staticSwitch6_g3904;
				float4 temp_output_1_0_g3940 = temp_output_3_0_g3908;
				float3 temp_output_2_0_g3940 = (temp_output_1_0_g3940).rgb;
				float4 break2_g3941 = float4( temp_output_2_0_g3940 , 0.0 );
				float temp_output_9_0_g3942 = max( _ColorReplaceContrast , 0.0 );
				float saferPower7_g3942 = max( ( ( ( break2_g3941.x + break2_g3941.y + break2_g3941.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3942 ) , 0.0 ) ) ) , 0.0001 );
				float3 hsvTorgb7_g3940 = RGBToHSV( (_ColorReplaceTargetColor).rgb );
				float3 hsvTorgb5_g3940 = RGBToHSV( temp_output_2_0_g3940 );
				float clampResult35_g3940 = clamp( ( 1.0 - ( min( min( distance( hsvTorgb7_g3940.x , hsvTorgb5_g3940.x ) , distance( hsvTorgb7_g3940.x , ( hsvTorgb5_g3940.x + 1.0 ) ) ) , distance( hsvTorgb7_g3940.x , ( hsvTorgb5_g3940.x + -1.0 ) ) ) / max( ( _ColorReplaceHueTolerance * 0.15 ) , 0.001 ) ) ) , 0.0 , 1.0 );
				float clampResult30_g3940 = clamp( ( 1.0 - ( distance( hsvTorgb7_g3940.y , hsvTorgb5_g3940.y ) / max( ( _ColorReplaceSaturationTolerance * 2.0 ) , 0.001 ) ) ) , 0.0 , 1.0 );
				float clampResult40_g3940 = clamp( ( 1.0 - ( distance( hsvTorgb7_g3940.z , hsvTorgb5_g3940.z ) / max( ( _ColorReplaceBrightnessTolerance * 1.5 ) , 0.001 ) ) ) , 0.0 , 1.0 );
				float saferPower48_g3940 = max( ( clampResult35_g3940 * clampResult30_g3940 * clampResult40_g3940 ) , 0.0001 );
				float3 lerpResult23_g3940 = lerp( temp_output_2_0_g3940 , ( pow( saferPower7_g3942 , temp_output_9_0_g3942 ) * (_ColorReplaceColor).rgb ) , ( pow( saferPower48_g3940 , max( _ColorReplaceBias , 0.001 ) ) * _ColorReplaceFade ));
				float4 appendResult4_g3940 = (float4(lerpResult23_g3940 , temp_output_1_0_g3940.a));
				#ifdef _ENABLECOLORREPLACE_ON
				float4 staticSwitch29_g3908 = appendResult4_g3940;
				#else
				float4 staticSwitch29_g3908 = temp_output_3_0_g3908;
				#endif
				float4 temp_output_1_0_g3933 = staticSwitch29_g3908;
				float3 saferPower5_g3933 = max( (temp_output_1_0_g3933).rgb , 0.0001 );
				float3 temp_cast_22 = (_Contrast).xxx;
				float4 appendResult4_g3933 = (float4(pow( saferPower5_g3933 , temp_cast_22 ) , temp_output_1_0_g3933.a));
				#ifdef _ENABLECONTRAST_ON
				float4 staticSwitch32_g3908 = appendResult4_g3933;
				#else
				float4 staticSwitch32_g3908 = staticSwitch29_g3908;
				#endif
				float4 temp_output_2_0_g3932 = staticSwitch32_g3908;
				float4 appendResult6_g3932 = (float4(( (temp_output_2_0_g3932).rgb * _Brightness ) , temp_output_2_0_g3932.a));
				#ifdef _ENABLEBRIGHTNESS_ON
				float4 staticSwitch33_g3908 = appendResult6_g3932;
				#else
				float4 staticSwitch33_g3908 = staticSwitch32_g3908;
				#endif
				float4 temp_output_2_0_g3931 = staticSwitch33_g3908;
				float3 hsvTorgb1_g3931 = RGBToHSV( temp_output_2_0_g3931.rgb );
				float3 hsvTorgb3_g3931 = HSVToRGB( float3(( hsvTorgb1_g3931.x + _Hue ),hsvTorgb1_g3931.y,hsvTorgb1_g3931.z) );
				float4 appendResult8_g3931 = (float4(hsvTorgb3_g3931 , temp_output_2_0_g3931.a));
				#ifdef _ENABLEHUE_ON
				float4 staticSwitch36_g3908 = appendResult8_g3931;
				#else
				float4 staticSwitch36_g3908 = staticSwitch33_g3908;
				#endif
				float4 temp_output_1_0_g3934 = staticSwitch36_g3908;
				float4 break2_g3935 = temp_output_1_0_g3934;
				float temp_output_3_0_g3934 = ( ( break2_g3935.x + break2_g3935.y + break2_g3935.z ) / 3.0 );
				float clampResult25_g3934 = clamp( ( ( ( ( temp_output_3_0_g3934 + _SplitToningShift ) - 0.5 ) * _SplitToningBalance ) + 0.5 ) , 0.0 , 1.0 );
				float3 lerpResult6_g3934 = lerp( (_SplitToningShadowsColor).rgb , (_SplitToningHighlightsColor).rgb , clampResult25_g3934);
				float temp_output_9_0_g3936 = max( _SplitToningContrast , 0.0 );
				float saferPower7_g3936 = max( ( temp_output_3_0_g3934 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3936 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult11_g3934 = lerp( (temp_output_1_0_g3934).rgb , ( lerpResult6_g3934 * pow( saferPower7_g3936 , temp_output_9_0_g3936 ) ) , _SplitToningFade);
				float4 appendResult18_g3934 = (float4(lerpResult11_g3934 , temp_output_1_0_g3934.a));
				#ifdef _ENABLESPLITTONING_ON
				float4 staticSwitch30_g3908 = appendResult18_g3934;
				#else
				float4 staticSwitch30_g3908 = staticSwitch36_g3908;
				#endif
				float4 temp_output_1_0_g3939 = staticSwitch30_g3908;
				float3 temp_output_4_0_g3939 = (temp_output_1_0_g3939).rgb;
				float4 break12_g3939 = temp_output_1_0_g3939;
				float3 lerpResult7_g3939 = lerp( temp_output_4_0_g3939 , ( temp_output_4_0_g3939 + (_BlackTintColor).rgb ) , pow( ( 1.0 - min( max( max( break12_g3939.r , break12_g3939.g ) , break12_g3939.b ) , 1.0 ) ) , max( _BlackTintPower , 0.001 ) ));
				float3 lerpResult13_g3939 = lerp( temp_output_4_0_g3939 , lerpResult7_g3939 , _BlackTintFade);
				float4 appendResult11_g3939 = (float4(lerpResult13_g3939 , break12_g3939.a));
				#ifdef _ENABLEBLACKTINT_ON
				float4 staticSwitch20_g3908 = appendResult11_g3939;
				#else
				float4 staticSwitch20_g3908 = staticSwitch30_g3908;
				#endif
				float4 temp_output_1_0_g3937 = staticSwitch20_g3908;
				float2 uv_RecolorTintAreas = IN.texcoord.xy * _RecolorTintAreas_ST.xy + _RecolorTintAreas_ST.zw;
				float3 hsvTorgb33_g3937 = RGBToHSV( tex2D( _RecolorTintAreas, uv_RecolorTintAreas ).rgb );
				float temp_output_43_0_g3937 = ( ( hsvTorgb33_g3937.x + 0.08333334 ) % 1.0 );
				float4 ifLocalVar46_g3937 = 0;
				if( temp_output_43_0_g3937 >= 0.8333333 )
				ifLocalVar46_g3937 = _RecolorPurpleTint;
				else
				ifLocalVar46_g3937 = _RecolorBlueTint;
				float4 ifLocalVar44_g3937 = 0;
				if( temp_output_43_0_g3937 <= 0.6666667 )
				ifLocalVar44_g3937 = _RecolorCyanTint;
				else
				ifLocalVar44_g3937 = ifLocalVar46_g3937;
				float4 ifLocalVar47_g3937 = 0;
				if( temp_output_43_0_g3937 <= 0.3333333 )
				ifLocalVar47_g3937 = _RecolorYellowTint;
				else
				ifLocalVar47_g3937 = _RecolorGreenTint;
				float4 ifLocalVar45_g3937 = 0;
				if( temp_output_43_0_g3937 <= 0.1666667 )
				ifLocalVar45_g3937 = _RecolorRedTint;
				else
				ifLocalVar45_g3937 = ifLocalVar47_g3937;
				float4 ifLocalVar35_g3937 = 0;
				if( temp_output_43_0_g3937 >= 0.5 )
				ifLocalVar35_g3937 = ifLocalVar44_g3937;
				else
				ifLocalVar35_g3937 = ifLocalVar45_g3937;
				float4 break55_g3937 = ifLocalVar35_g3937;
				float3 appendResult56_g3937 = (float3(break55_g3937.r , break55_g3937.g , break55_g3937.b));
				float4 break2_g3938 = temp_output_1_0_g3937;
				float saferPower57_g3937 = max( ( ( break2_g3938.x + break2_g3938.y + break2_g3938.z ) / 3.0 ) , 0.0001 );
				float3 lerpResult26_g3937 = lerp( (temp_output_1_0_g3937).rgb , ( appendResult56_g3937 * pow( saferPower57_g3937 , max( ( break55_g3937.a * 2.0 ) , 0.01 ) ) ) , ( hsvTorgb33_g3937.z * _RecolorFade ));
				float4 appendResult30_g3937 = (float4(lerpResult26_g3937 , temp_output_1_0_g3937.a));
				#ifdef _ENABLERECOLOR_ON
				float4 staticSwitch9_g3908 = appendResult30_g3937;
				#else
				float4 staticSwitch9_g3908 = staticSwitch20_g3908;
				#endif
				float4 temp_output_1_0_g3917 = staticSwitch9_g3908;
				float4 break2_g3919 = temp_output_1_0_g3917;
				float temp_output_9_0_g3918 = max( _InkSpreadContrast , 0.0 );
				float saferPower7_g3918 = max( ( ( ( break2_g3919.x + break2_g3919.y + break2_g3919.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3918 ) , 0.0 ) ) ) , 0.0001 );
				float2 temp_output_65_0_g3917 = shaderPosition235;
				float clampResult53_g3917 = clamp( ( ( ( _InkSpreadDistance - distance( _InkSpreadPosition , temp_output_65_0_g3917 ) ) + ( tex2D( _UberNoiseTexture, ( temp_output_65_0_g3917 * _InkSpreadNoiseScale ) ).r * _InkSpreadNoiseFactor ) ) / max( _InkSpreadWidth , 0.001 ) ) , 0.0 , 1.0 );
				float3 lerpResult7_g3917 = lerp( (temp_output_1_0_g3917).rgb , ( (_InkSpreadColor).rgb * pow( saferPower7_g3918 , temp_output_9_0_g3918 ) ) , ( _InkSpreadFade * clampResult53_g3917 ));
				float4 appendResult9_g3917 = (float4(lerpResult7_g3917 , (temp_output_1_0_g3917).a));
				#ifdef _ENABLEINKSPREAD_ON
				float4 staticSwitch17_g3908 = appendResult9_g3917;
				#else
				float4 staticSwitch17_g3908 = staticSwitch9_g3908;
				#endif
				float4 temp_output_1_0_g3915 = staticSwitch17_g3908;
				float3 temp_output_34_0_g3915 = (temp_output_1_0_g3915).rgb;
				float temp_output_39_0_g3908 = shaderTime237;
				float3 hsvTorgb15_g3915 = RGBToHSV( temp_output_34_0_g3915 );
				float3 hsvTorgb19_g3915 = HSVToRGB( float3(( ( temp_output_39_0_g3908 * _ShiftHueSpeed ) + hsvTorgb15_g3915.x ),hsvTorgb15_g3915.y,hsvTorgb15_g3915.z) );
				float2 uv_ShiftHueShaderMask = IN.texcoord.xy * _ShiftHueShaderMask_ST.xy + _ShiftHueShaderMask_ST.zw;
				float4 tex2DNode3_g3916 = tex2D( _ShiftHueShaderMask, uv_ShiftHueShaderMask );
				float3 lerpResult33_g3915 = lerp( temp_output_34_0_g3915 , hsvTorgb19_g3915 , ( _ShiftHueFade * ( tex2DNode3_g3916.r * tex2DNode3_g3916.a ) ));
				float4 appendResult6_g3915 = (float4(lerpResult33_g3915 , temp_output_1_0_g3915.a));
				#ifdef _ENABLESHIFTHUE_ON
				float4 staticSwitch19_g3908 = appendResult6_g3915;
				#else
				float4 staticSwitch19_g3908 = staticSwitch17_g3908;
				#endif
				float3 hsvTorgb3_g3928 = HSVToRGB( float3(( temp_output_39_0_g3908 * _AddHueSpeed ),1.0,1.0) );
				float3 hsvTorgb15_g3927 = RGBToHSV( hsvTorgb3_g3928 );
				float3 hsvTorgb19_g3927 = HSVToRGB( float3(hsvTorgb15_g3927.x,_AddHueSaturation,( hsvTorgb15_g3927.z * _AddHueBrightness )) );
				float4 temp_output_1_0_g3927 = staticSwitch19_g3908;
				float4 break2_g3930 = temp_output_1_0_g3927;
				float saferPower27_g3927 = max( ( ( break2_g3930.x + break2_g3930.y + break2_g3930.z ) / 3.0 ) , 0.0001 );
				float2 uv_AddHueShaderMask = IN.texcoord.xy * _AddHueShaderMask_ST.xy + _AddHueShaderMask_ST.zw;
				float4 tex2DNode3_g3929 = tex2D( _AddHueShaderMask, uv_AddHueShaderMask );
				float4 appendResult6_g3927 = (float4(( ( hsvTorgb19_g3927 * pow( saferPower27_g3927 , max( _AddHueContrast , 0.001 ) ) * ( _AddHueFade * ( tex2DNode3_g3929.r * tex2DNode3_g3929.a ) ) ) + (temp_output_1_0_g3927).rgb ) , temp_output_1_0_g3927.a));
				#ifdef _ENABLEADDHUE_ON
				float4 staticSwitch23_g3908 = appendResult6_g3927;
				#else
				float4 staticSwitch23_g3908 = staticSwitch19_g3908;
				#endif
				float4 temp_output_1_0_g3909 = staticSwitch23_g3908;
				float4 break2_g3910 = temp_output_1_0_g3909;
				float temp_output_9_0_g3911 = max( _SineGlowContrast , 0.0 );
				float saferPower7_g3911 = max( ( ( ( break2_g3910.x + break2_g3910.y + break2_g3910.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3911 ) , 0.0 ) ) ) , 0.0001 );
				float2 uv_SineGlowShaderMask = IN.texcoord.xy * _SineGlowShaderMask_ST.xy + _SineGlowShaderMask_ST.zw;
				float4 tex2DNode3_g3912 = tex2D( _SineGlowShaderMask, uv_SineGlowShaderMask );
				float4 appendResult21_g3909 = (float4(( (temp_output_1_0_g3909).rgb + ( pow( saferPower7_g3911 , temp_output_9_0_g3911 ) * ( _SineGlowFade * ( tex2DNode3_g3912.r * tex2DNode3_g3912.a ) ) * (_SineGlowColor).rgb * ( ( ( sin( ( temp_output_39_0_g3908 * _SineGlowFrequency ) ) + 1.0 ) * ( _SineGlowMax - _SineGlowMin ) ) + _SineGlowMin ) ) ) , temp_output_1_0_g3909.a));
				#ifdef _ENABLESINEGLOW_ON
				float4 staticSwitch28_g3908 = appendResult21_g3909;
				#else
				float4 staticSwitch28_g3908 = staticSwitch23_g3908;
				#endif
				float4 temp_output_1_0_g3913 = staticSwitch28_g3908;
				float4 break2_g3914 = temp_output_1_0_g3913;
				float3 temp_cast_41 = (( ( break2_g3914.x + break2_g3914.y + break2_g3914.z ) / 3.0 )).xxx;
				float3 lerpResult5_g3913 = lerp( temp_cast_41 , (temp_output_1_0_g3913).rgb , _Saturation);
				float4 appendResult8_g3913 = (float4(lerpResult5_g3913 , temp_output_1_0_g3913.a));
				#ifdef _ENABLESATURATION_ON
				float4 staticSwitch38_g3908 = appendResult8_g3913;
				#else
				float4 staticSwitch38_g3908 = staticSwitch28_g3908;
				#endif
				float4 temp_output_15_0_g3924 = staticSwitch38_g3908;
				float2 temp_output_1_0_g3908 = finalUV146;
				float2 temp_output_7_0_g3924 = temp_output_1_0_g3908;
				#ifdef _INNEROUTLINEDISTORTIONTOGGLE_ON
				float2 staticSwitch169_g3924 = ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_39_0_g3908 * _InnerOutlineNoiseSpeed ) + temp_output_7_0_g3924 ) * _InnerOutlineNoiseScale ) ).r - 0.5 ) * _InnerOutlineDistortionIntensity );
				#else
				float2 staticSwitch169_g3924 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g3924 = ( staticSwitch169_g3924 + temp_output_7_0_g3924 );
				...
				float3 lerpResult176_g3924 = lerp( (temp_output_15_0_g3924).rgb , (_InnerOutlineColor).rgb , ( _InnerOutlineFade * ( 1.0 - min( min( min( min( min( min( min( tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g3924 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g3924 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3924 + ( ( _InnerOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g3924 ) ) ).a ) ) ));
				float4 appendResult177_g3924 = (float4(lerpResult176_g3924 , temp_output_15_0_g3924.a));
				#ifdef _ENABLEINNEROUTLINE_ON
				float4 staticSwitch12_g3908 = appendResult177_g3924;
				#else
				float4 staticSwitch12_g3908 = staticSwitch38_g3908;
				#endif
				float4 temp_output_15_0_g3921 = staticSwitch12_g3908;
				float3 temp_output_82_0_g3921 = (_OuterOutlineColor).rgb;
				float temp_output_182_0_g3921 = ( ( 1.0 - temp_output_15_0_g3921.a ) * min( ( _OuterOutlineFade * 3.0 ) , 1.0 ) );
				float3 lerpResult178_g3921 = lerp( (temp_output_15_0_g3921).rgb , temp_output_82_0_g3921 , temp_output_182_0_g3921);
				float3 lerpResult170_g3921 = lerp( lerpResult178_g3921 , temp_output_82_0_g3921 , temp_output_182_0_g3921);
				float2 temp_output_7_0_g3921 = temp_output_1_0_g3908;
				#ifdef _OUTEROUTLINEDISTORTIONTOGGLE_ON
				float2 staticSwitch157_g3921 = ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_39_0_g3908 * _OuterOutlineNoiseSpeed ) + temp_output_7_0_g3921 ) * _OuterOutlineNoiseScale ) ).r - 0.5 ) * _OuterOutlineDistortionIntensity );
				#else
				float2 staticSwitch157_g3921 = float2( 0,0 );
				#endif
				float2 temp_output_131_0_g3921 = ( staticSwitch157_g3921 + temp_output_7_0_g3921 );
				float2 appendResult2_g3923 = (float2(_MainTex_TexelSize.z , _MainTex_TexelSize.w));
				float2 temp_output_25_0_g3921 = ( 100.0 / appendResult2_g3923 );
				float lerpResult168_g3921 = lerp( temp_output_15_0_g3921.a , min( ( max( max( max( max( max( max( max( tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( 0,-1 ) ) * temp_output_25_0_g3921 ) ) ).a , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( 0,1 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( -1,0 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( 1,0 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( 0.705,0.705 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( -0.705,0.705 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( 0.705,-0.705 ) ) * temp_output_25_0_g3921 ) ) ).a ) , tex2D( _MainTex, ( temp_output_131_0_g3921 + ( ( _OuterOutlineWidth * float2( -0.705,-0.705 ) ) * temp_output_25_0_g3921 ) ) ).a ) * 3.0 ) , 1.0 ) , _OuterOutlineFade);
				float4 appendResult174_g3921 = (float4(lerpResult170_g3921 , lerpResult168_g3921));
				#ifdef _ENABLEOUTEROUTLINE_ON
				float4 staticSwitch13_g3908 = appendResult174_g3921;
				#else
				float4 staticSwitch13_g3908 = staticSwitch12_g3908;
				#endif
				float4 temp_output_241_0 = staticSwitch13_g3908;
				float4 temp_output_1_0_g3943 = temp_output_241_0;
				float4 break2_g3944 = temp_output_1_0_g3943;
				float temp_output_9_0_g3945 = max( _HologramContrast , 0.0 );
				...
				float4 appendResult22_g3943 = (float4(( (_HologramTint).rgb * pow( saferPower7_g3945 , temp_output_9_0_g3945 ) ) , ( max( pow( abs( sin( ( ( ( ( shaderTime237 * _HologramLineSpeed ) + ase_worldPos.y ) / unity_OrthoParams.y ) * _HologramLineFrequency ) ) ) , _HologramLineGap ) , _HologramMinAlpha ) * temp_output_1_0_g3943.a )));
				float4 lerpResult37_g3943 = lerp( temp_output_1_0_g3943 , appendResult22_g3943 , hologramFade182);
				#ifdef _ENABLEHOLOGRAM_ON
				float4 staticSwitch56 = lerpResult37_g3943;
				#else
				float4 staticSwitch56 = temp_output_241_0;
				#endif
				float4 temp_output_1_0_g3946 = staticSwitch56;
				float4 break2_g3948 = temp_output_1_0_g3946;
				float temp_output_34_0_g3946 = shaderTime237;
				float3 hsvTorgb3_g3949 = HSVToRGB( float3(( tex2D( _UberNoiseTexture, ( ( glitchPosition154 + ( _GlitchNoiseSpeed * temp_output_34_0_g3946 ) ) * _GlitchNoiseScale ) ).r + ( temp_output_34_0_g3946 * _GlitchHueSpeed ) ),1.0,1.0) );
				float3 lerpResult23_g3946 = lerp( (temp_output_1_0_g3946).rgb , ( ( ( break2_g3948.x + break2_g3948.y + break2_g3948.z ) / 3.0 ) * _GlitchBrightness * hsvTorgb3_g3949 ) , glitchFade152);
				float4 appendResult27_g3946 = (float4(lerpResult23_g3946 , temp_output_1_0_g3946.a));
				#ifdef _ENABLEGLITCH_ON
				float4 staticSwitch57 = appendResult27_g3946;
				#else
				float4 staticSwitch57 = staticSwitch56;
				#endif
				float4 temp_output_3_0_g3950 = staticSwitch57;
				float4 temp_output_1_0_g3954 = temp_output_3_0_g3950;
				float2 temp_output_41_0_g3950 = shaderPosition235;
				float2 temp_output_99_0_g3954 = temp_output_41_0_g3950;
				float temp_output_40_0_g3950 = shaderTime237;
				float clampResult52_g3954 = clamp( ( ( _CamouflageDensityA - tex2D( _UberNoiseTexture, ( (( _CamouflageAnimated )?( ( ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g3950 * _CamouflageAnimationSpeed ) + temp_output_99_0_g3954 ) * _CamouflageDistortionScale ) ).r - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g3954 ) ):( temp_output_99_0_g3954 )) * _CamouflageNoiseScaleA ) ).r ) / max( _CamouflageSmoothnessA , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult55_g3954 = lerp( _CamouflageBaseColor , ( _CamouflageColorA * clampResult52_g3954 ) , clampResult52_g3954);
				float clampResult65_g3954 = clamp( ( ( _CamouflageDensityB - tex2D( _UberNoiseTexture, ( ( (( _CamouflageAnimated )?( ( ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_40_0_g3950 * _CamouflageAnimationSpeed ) + temp_output_99_0_g3954 ) * _CamouflageDistortionScale ) ).r - 0.25 ) * _CamouflageDistortionIntensity ) + temp_output_99_0_g3954 ) ):( temp_output_99_0_g3954 )) + float2( 12.3,12.3 ) ) * _CamouflageNoiseScaleB ) ).r ) / max( _CamouflageSmoothnessB , 0.005 ) ) , 0.0 , 1.0 );
				float4 lerpResult68_g3954 = lerp( lerpResult55_g3954 , ( _CamouflageColorB * clampResult65_g3954 ) , clampResult65_g3954);
				float4 break2_g3957 = temp_output_1_0_g3954;
				float temp_output_9_0_g3956 = max( _CamouflageContrast , 0.0 );
				float saferPower7_g3956 = max( ( ( ( break2_g3957.x + break2_g3957.y + break2_g3957.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3956 ) , 0.0 ) ) ) , 0.0001 );
				float2 uv_CamouflageShaderMask = IN.texcoord.xy * _CamouflageShaderMask_ST.xy + _CamouflageShaderMask_ST.zw;
				float4 tex2DNode3_g3958 = tex2D( _CamouflageShaderMask, uv_CamouflageShaderMask );
				float3 lerpResult4_g3954 = lerp( (temp_output_1_0_g3954).rgb , ( (lerpResult68_g3954).rgb * pow( saferPower7_g3956 , temp_output_9_0_g3956 ) ) , ( _CamouflageFade * ( tex2DNode3_g3958.r * tex2DNode3_g3958.a ) ));
				float4 appendResult7_g3954 = (float4(lerpResult4_g3954 , temp_output_1_0_g3954.a));
				#ifdef _ENABLECAMOUFLAGE_ON
				float4 staticSwitch26_g3950 = appendResult7_g3954;
				#else
				float4 staticSwitch26_g3950 = temp_output_3_0_g3950;
				#endif
				float4 temp_output_1_0_g3961 = staticSwitch26_g3950;
				float temp_output_59_0_g3961 = temp_output_40_0_g3950;
				float2 temp_output_58_0_g3961 = temp_output_41_0_g3950;
				float4 break2_g3963 = temp_output_1_0_g3961;
				float temp_output_5_0_g3961 = ( ( break2_g3963.x + break2_g3963.y + break2_g3963.z ) / 3.0 );
				float temp_output_9_0_g3966 = max( _MetalHighlightContrast , 0.0 );
				float saferPower7_g3966 = max( ( temp_output_5_0_g3961 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3966 ) , 0.0 ) ) ) , 0.0001 );
				float saferPower2_g3961 = max( temp_output_5_0_g3961 , 0.0001 );
				float2 uv_MetalShaderMask = IN.texcoord.xy * _MetalShaderMask_ST.xy + _MetalShaderMask_ST.zw;
				float4 tex2DNode3_g3962 = tex2D( _MetalShaderMask, uv_MetalShaderMask );
				float4 lerpResult45_g3961 = lerp( temp_output_1_0_g3961 , ( ( max( ( ( _MetalHighlightDensity - tex2D( _UberNoiseTexture, ( ( ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_59_0_g3961 * _MetalNoiseDistortionSpeed ) + temp_output_58_0_g3961 ) * _MetalNoiseDistortionScale ) ).r - 0.25 ) * _MetalNoiseDistortion ) + ( ( temp_output_59_0_g3961 * _MetalNoiseSpeed ) + temp_output_58_0_g3961 ) ) * _MetalNoiseScale ) ).r ) / max( _MetalHighlightDensity , 0.01 ) ) , 0.0 ) * _MetalHighlightColor * pow( saferPower7_g3966 , temp_output_9_0_g3966 ) ) + ( pow( saferPower2_g3961 , _MetalContrast ) * _MetalColor ) ) , ( _MetalFade * ( tex2DNode3_g3962.r * tex2DNode3_g3962.a ) ));
				float4 appendResult8_g3961 = (float4((lerpResult45_g3961).rgb , (temp_output_1_0_g3961).a));
				#ifdef _ENABLEMETAL_ON
				float4 staticSwitch28_g3950 = appendResult8_g3961;
				#else
				float4 staticSwitch28_g3950 = staticSwitch26_g3950;
				#endif
				float4 temp_output_1_0_g3967 = staticSwitch28_g3950;
				float4 break2_g3970 = temp_output_1_0_g3967;
				float temp_output_7_0_g3967 = ( ( break2_g3970.x + break2_g3970.y + break2_g3970.z ) / 3.0 );
				float temp_output_9_0_g3972 = max( _FrozenContrast , 0.0 );
				float saferPower7_g3972 = max( ( temp_output_7_0_g3967 + ( 0.1 * max( ( 1.0 - temp_output_9_0_g3972 ) , 0.0 ) ) ) , 0.0001 );
				float saferPower20_g3967 = max( temp_output_7_0_g3967 , 0.0001 );
				float2 temp_output_72_0_g3967 = temp_output_41_0_g3950;
				float temp_output_73_0_g3967 = temp_output_40_0_g3950;
				float saferPower42_g3967 = max( temp_output_7_0_g3967 , 0.0001 );
				float3 lerpResult57_g3967 = lerp( (temp_output_1_0_g3967).rgb , ( ( pow( saferPower7_g3972 , temp_output_9_0_g3972 ) * (_FrozenTint).rgb ) + ( pow( saferPower20_g3967 , _FrozenSnowContrast ) * ( (_FrozenSnowColor).rgb * max( ( _FrozenSnowDensity - tex2D( _UberNoiseTexture, ( temp_output_72_0_g3967 * _FrozenSnowScale ) ).r ) , 0.0 ) ) ) + (( max( ( ( _FrozenHighlightDensity - tex2D( _UberNoiseTexture, ( ( ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_73_0_g3967 * _FrozenHighlightDistortionSpeed ) + temp_output_72_0_g3967 ) * _FrozenHighlightDistortionScale ) ).r - 0.25 ) * _FrozenHighlightDistortion ) + ( ( temp_output_73_0_g3967 * _FrozenHighlightSpeed ) + temp_output_72_0_g3967 ) ) * _FrozenHighlightScale ) ).r ) / max( _FrozenHighlightDensity , 0.01 ) ) , 0.0 ) * _FrozenHighlightColor * pow( saferPower42_g3967 , _FrozenHighlightContrast ) )).rgb ) , _FrozenFade);
				float4 appendResult26_g3967 = (float4(lerpResult57_g3967 , temp_output_1_0_g3967.a));
				#ifdef _ENABLEFROZEN_ON
				float4 staticSwitch29_g3950 = appendResult26_g3967;
				#else
				float4 staticSwitch29_g3950 = staticSwitch28_g3950;
				#endif
				float4 temp_output_1_0_g3973 = staticSwitch29_g3950;
				float3 temp_output_28_0_g3973 = (temp_output_1_0_g3973).rgb;
				float4 break2_g3974 = float4( temp_output_28_0_g3973 , 0.0 );
				float saferPower21_g3973 = max( ( ( break2_g3974.x + break2_g3974.y + break2_g3974.z ) / 3.0 ) , 0.0001 );
				float2 temp_output_72_0_g3973 = temp_output_41_0_g3950;
				float clampResult68_g3973 = clamp( ( _BurnInsideNoiseFactor - tex2D( _UberNoiseTexture, ( ( ( ( tex2D( _UberNoiseTexture, ( temp_output_72_0_g3973 * _BurnSwirlNoiseScale ) ).r - 0.5 ) * float2( 1,1 ) * _BurnSwirlFactor ) + temp_output_72_0_g3973 ) * _BurnInsideNoiseScale ) ).r ) , 0.0 , 1.0 );
				float temp_output_15_0_g3973 = ( ( ( _BurnRadius - distance( temp_output_72_0_g3973 , _BurnPosition ) ) + ( tex2D( _UberNoiseTexture, ( temp_output_72_0_g3973 * _BurnEdgeNoiseScale ) ).r * _BurnEdgeNoiseFactor ) ) / max( _BurnWidth , 0.01 ) );
				float clampResult18_g3973 = clamp( temp_output_15_0_g3973 , 0.0 , 1.0 );
				float3 lerpResult29_g3973 = lerp( temp_output_28_0_g3973 , ( pow( saferPower21_g3973 , max( _BurnInsideContrast , 0.001 ) ) * ( ( (_BurnInsideNoiseColor).rgb * clampResult68_g3973 ) + (_BurnInsideColor).rgb ) ) , clampResult18_g3973);
				float3 lerpResult40_g3973 = lerp( temp_output_28_0_g3973 , ( lerpResult29_g3973 + ( ( step( temp_output_15_0_g3973 , 1.0 ) * step( 0.0 , temp_output_15_0_g3973 ) ) * (_BurnEdgeColor).rgb ) ) , _BurnFade);
				float4 appendResult43_g3973 = (float4(lerpResult40_g3973 , temp_output_1_0_g3973.a));
				#ifdef _ENABLEBURN_ON
				float4 staticSwitch32_g3950 = appendResult43_g3973;
				#else
				float4 staticSwitch32_g3950 = staticSwitch29_g3950;
				#endif
				float2 temp_output_42_0_g3978 = temp_output_41_0_g3950;
				float3 hsvTorgb3_g3980 = HSVToRGB( float3(( ( ( distance( temp_output_42_0_g3978 , _RainbowCenter ) + ( tex2D( _UberNoiseTexture, ( temp_output_42_0_g3978 * _RainbowNoiseScale ) ).r * _RainbowNoiseFactor ) ) * _RainbowDensity ) + ( _RainbowSpeed * temp_output_40_0_g3950 ) ),1.0,1.0) );
				float3 hsvTorgb36_g3978 = RGBToHSV( hsvTorgb3_g3980 );
				float3 hsvTorgb37_g3978 = HSVToRGB( float3(hsvTorgb36_g3978.x,_RainbowSaturation,( hsvTorgb36_g3978.z * _RainbowBrightness )) );
				float4 temp_output_1_0_g3978 = staticSwitch32_g3950;
				float4 break2_g3979 = temp_output_1_0_g3978;
				float saferPower24_g3978 = max( ( ( break2_g3979.x + break2_g3979.y + break2_g3979.z ) / 3.0 ) , 0.0001 );
				float2 uv_RainbowMask = IN.texcoord.xy * _RainbowMask_ST.xy + _RainbowMask_ST.zw;
				float4 tex2DNode3_g3981 = tex2D( _RainbowMask, uv_RainbowMask );
				float4 appendResult29_g3978 = (float4(( ( hsvTorgb37_g3978 * pow( saferPower24_g3978 , max( _RainbowContrast , 0.001 ) ) * ( _RainbowFade * ( tex2DNode3_g3981.r * tex2DNode3_g3981.a ) ) ) + (temp_output_1_0_g3978).rgb ) , temp_output_1_0_g3978.a));
				#ifdef _ENABLERAINBOW_ON
				float4 staticSwitch34_g3950 = appendResult29_g3978;
				#else
				float4 staticSwitch34_g3950 = staticSwitch32_g3950;
				#endif
				float4 temp_output_1_0_g3983 = staticSwitch34_g3950;
				float3 temp_output_57_0_g3983 = (temp_output_1_0_g3983).rgb;
				float4 break2_g3984 = temp_output_1_0_g3983;
				float3 temp_cast_61 = (( ( break2_g3984.x + break2_g3984.y + break2_g3984.z ) / 3.0 )).xxx;
				float3 lerpResult92_g3983 = lerp( temp_cast_61 , temp_output_57_0_g3983 , _ShineSaturation);
				float3 saferPower83_g3983 = max( lerpResult92_g3983 , 0.0001 );
				float3 temp_cast_62 = (max( _ShineContrast , 0.001 )).xxx;
				float3 rotatedValue69_g3983 = RotateAroundAxis( float3( 0,0,0 ), float3( ( ( temp_output_40_0_g3950 * _ShineSpeed ) + ( _ShineScale * temp_output_41_0_g3950 ) ) ,  0.0 ), float3( 0,0,1 ), ( ( _ShineRotation / 360.0 ) * UNITY_PI ) );
				float3 break67_g3983 = rotatedValue69_g3983;
				float temp_output_97_0_g3983 = ( _ShineWidth + -1.0 );
				float clampResult80_g3983 = clamp( ( ( ( sin( ( ( break67_g3983.x + break67_g3983.y ) * 10.0 ) ) + temp_output_97_0_g3983 ) * ( 2.0 - temp_output_97_0_g3983 ) ) * _ShineSmoothness ) , 0.0 , 1.0 );
				float2 uv_ShineShaderMask = IN.texcoord.xy * _ShineShaderMask_ST.xy + _ShineShaderMask_ST.zw;
				float4 tex2DNode3_g3985 = tex2D( _ShineShaderMask, uv_ShineShaderMask );
				float4 appendResult8_g3983 = (float4(( temp_output_57_0_g3983 + ( ( pow( saferPower83_g3983 , temp_cast_62 ) * (_ShineColor).rgb ) * clampResult80_g3983 * ( _ShineFade * ( tex2DNode3_g3985.r * tex2DNode3_g3985.a ) ) ) ) , (temp_output_1_0_g3983).a));
				#ifdef _ENABLESHINE_ON
				float4 staticSwitch36_g3950 = appendResult8_g3983;
				#else
				float4 staticSwitch36_g3950 = staticSwitch34_g3950;
				#endif
				float temp_output_41_0_g3951 = temp_output_40_0_g3950;
				float saferPower19_g3951 = max( abs( ( ( ( tex2D( _UberNoiseTexture, ( ( ( temp_output_41_0_g3951 * _PoisonNoiseSpeed ) + temp_output_41_0_g3950 ) * _PoisonNoiseScale ) ).r + ( temp_output_41_0_g3951 * _PoisonShiftSpeed ) ) % 1.0 ) + -0.5 ) ) , 0.0001 );
				float3 temp_output_24_0_g3951 = (_PoisonColor).rgb;
				float4 temp_output_1_0_g3951 = staticSwitch36_g3950;
				float3 temp_output_28_0_g3951 = (temp_output_1_0_g3951).rgb;
				float4 break2_g3953 = float4( temp_output_28_0_g3951 , 0.0 );
				float3 lerpResult32_g3951 = lerp( temp_output_28_0_g3951 , ( temp_output_24_0_g3951 * ( ( break2_g3953.x + break2_g3953.y + break2_g3953.z ) / 3.0 ) ) , ( _PoisonFade * _PoisonRecolorFactor ));
				float4 appendResult27_g3951 = (float4(( ( max( pow( saferPower19_g3951 , _PoisonDensity ) , 0.0 ) * temp_output_24_0_g3951 * _PoisonFade * _PoisonNoiseBrightness ) + lerpResult32_g3951 ) , temp_output_1_0_g3951.a));
				#ifdef _ENABLEPOISON_ON
				float4 staticSwitch39_g3950 = appendResult27_g3951;
				#else
				float4 staticSwitch39_g3950 = staticSwitch36_g3950;
				#endif
				float4 temp_output_245_0 = staticSwitch39_g3950;
				float4 break4_g3986 = temp_output_245_0;
				float fullDistortionAlpha164 = _FullDistortionFade;
				float4 appendResult5_g3986 = (float4(break4_g3986.r , break4_g3986.g , break4_g3986.b , ( break4_g3986.a * fullDistortionAlpha164 )));
				#ifdef _ENABLEFULLDISTORTION_ON
				float4 staticSwitch77 = appendResult5_g3986;
				#else
				float4 staticSwitch77 = temp_output_245_0;
				#endif
				float4 break4_g3987 = staticSwitch77;
				float directionalDistortionAlpha167 = (( _DirectionalDistortionInvert )?( ( 1.0 - clampResult154_g3868 ) ):( clampResult154_g3868 ));
				float4 appendResult5_g3987 = (float4(break4_g3987.r , break4_g3987.g , break4_g3987.b , ( break4_g3987.a * directionalDistortionAlpha167 )));
				#ifdef _ENABLEDIRECTIONALDISTORTION_ON
				float4 staticSwitch75 = appendResult5_g3987;
				#else
				float4 staticSwitch75 = staticSwitch77;
				#endif
				float4 temp_output_1_0_g3988 = staticSwitch75;
				float4 temp_output_1_0_g3989 = temp_output_1_0_g3988;
				float temp_output_53_0_g3989 = max( _FullAlphaDissolveWidth , 0.001 );
				float2 temp_output_18_0_g3988 = shaderPosition235;
				float clampResult17_g3989 = clamp( ( ( ( _FullAlphaDissolveFade * ( 1.0 + temp_output_53_0_g3989 ) ) - tex2D( _UberNoiseTexture, ( temp_output_18_0_g3988 * _FullAlphaDissolveNoiseScale ) ).r ) / temp_output_53_0_g3989 ) , 0.0 , 1.0 );
				float4 appendResult3_g3989 = (float4((temp_output_1_0_g3989).rgb , ( temp_output_1_0_g3989.a * clampResult17_g3989 )));
				#ifdef _ENABLEFULLALPHADISSOLVE_ON
				float4 staticSwitch3_g3988 = appendResult3_g3989;
				#else
				float4 staticSwitch3_g3988 = temp_output_1_0_g3988;
				#endif
				float temp_output_5_0_g3997 = tex2D( _UberNoiseTexture, ( temp_output_18_0_g3988 * _FullGlowDissolveNoiseScale ) ).r;
				float temp_output_61_0_g3997 = step( temp_output_5_0_g3997 , _FullGlowDissolveFade );
				float temp_output_53_0_g3997 = max( ( _FullGlowDissolveFade * _FullGlowDissolveWidth ) , 0.001 );
				float4 temp_output_1_0_g3997 = staticSwitch3_g3988;
				float4 appendResult3_g3997 = (float4(( ( (_FullGlowDissolveEdgeColor).rgb * ( temp_output_61_0_g3997 - step( temp_output_5_0_g3997 , ( ( _FullGlowDissolveFade * ( 1.01 + temp_output_53_0_g3997 ) ) - temp_output_53_0_g3997 ) ) ) ) + (temp_output_1_0_g3997).rgb ) , ( temp_output_1_0_g3997.a * temp_output_61_0_g3997 )));
				#ifdef _ENABLEFULLGLOWDISSOLVE_ON
				float4 staticSwitch5_g3988 = appendResult3_g3997;
				#else
				float4 staticSwitch5_g3988 = staticSwitch3_g3988;
				#endif
				float4 temp_output_1_0_g3999 = staticSwitch5_g3988;
				float2 temp_output_76_0_g3999 = temp_output_18_0_g3988;
				float clampResult17_g3999 = clamp( ( ( _SourceAlphaDissolveFade - ( distance( _SourceAlphaDissolvePosition , temp_output_76_0_g3999 ) + ( tex2D( _UberNoiseTexture, ( temp_output_76_0_g3999 * _SourceAlphaDissolveNoiseScale ) ).r * _SourceAlphaDissolveNoiseFactor ) ) ) / max( _SourceAlphaDissolveWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g3999 = (float4((temp_output_1_0_g3999).rgb , ( temp_output_1_0_g3999.a * (( _SourceAlphaDissolveInvert )?( ( 1.0 - clampResult17_g3999 ) ):( clampResult17_g3999 )) )));
				#ifdef _ENABLESOURCEALPHADISSOLVE_ON
				float4 staticSwitch8_g3988 = appendResult3_g3999;
				#else
				float4 staticSwitch8_g3988 = staticSwitch5_g3988;
				#endif
				float2 temp_output_90_0_g3995 = temp_output_18_0_g3988;
				float temp_output_65_0_g3995 = ( distance( _SourceGlowDissolvePosition , temp_output_90_0_g3995 ) + ( tex2D( _UberNoiseTexture, ( temp_output_90_0_g3995 * _SourceGlowDissolveNoiseScale ) ).r * _SourceGlowDissolveNoiseFactor ) );
				float temp_output_75_0_g3995 = step( temp_output_65_0_g3995 , _SourceGlowDissolveFade );
				float temp_output_76_0_g3995 = step( temp_output_65_0_g3995 , ( _SourceGlowDissolveFade - max( _SourceGlowDissolveWidth , 0.001 ) ) );
				float4 temp_output_1_0_g3995 = staticSwitch8_g3988;
				float4 appendResult3_g3995 = (float4(( ( max( ( temp_output_75_0_g3995 - temp_output_76_0_g3995 ) , 0.0 ) * (_SourceGlowDissolveEdgeColor).rgb ) + (temp_output_1_0_g3995).rgb ) , ( temp_output_1_0_g3995.a * (( _SourceGlowDissolveInvert )?( ( 1.0 - temp_output_76_0_g3995 ) ):( temp_output_75_0_g3995 )) )));
				#ifdef _ENABLESOURCEGLOWDISSOLVE_ON
				float4 staticSwitch9_g3988 = appendResult3_g3995;
				#else
				float4 staticSwitch9_g3988 = staticSwitch8_g3988;
				#endif
				float4 temp_output_1_0_g3991 = staticSwitch9_g3988;
				float2 temp_output_161_0_g3991 = temp_output_18_0_g3988;
				float3 rotatedValue136_g3991 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_161_0_g3991 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalAlphaFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g3991 = rotatedValue136_g3991;
				float clampResult154_g3991 = clamp( ( ( break130_g3991.x + break130_g3991.y + _DirectionalAlphaFadeFade + ( tex2D( _UberNoiseTexture, ( temp_output_161_0_g3991 * _DirectionalAlphaFadeNoiseScale ) ).r * _DirectionalAlphaFadeNoiseFactor ) ) / max( _DirectionalAlphaFadeWidth , 0.001 ) ) , 0.0 , 1.0 );
				float4 appendResult3_g3991 = (float4((temp_output_1_0_g3991).rgb , ( temp_output_1_0_g3991.a * (( _DirectionalAlphaFadeInvert )?( ( 1.0 - clampResult154_g3991 ) ):( clampResult154_g3991 )) )));
				#ifdef _ENABLEDIRECTIONALALPHAFADE_ON
				float4 staticSwitch11_g3988 = appendResult3_g3991;
				#else
				float4 staticSwitch11_g3988 = staticSwitch9_g3988;
				#endif
				float2 temp_output_171_0_g3993 = temp_output_18_0_g3988;
				float3 rotatedValue136_g3993 = RotateAroundAxis( float3( 0,0,0 ), float3( temp_output_171_0_g3993 ,  0.0 ), float3( 0,0,1 ), ( ( ( _DirectionalGlowFadeRotation / 360.0 ) + -0.25 ) * UNITY_PI ) );
				float3 break130_g3993 = rotatedValue136_g3993;
				float temp_output_168_0_g3993 = max( ( ( break130_g3993.x + break130_g3993.y + _DirectionalGlowFadeFade + ( tex2D( _UberNoiseTexture, ( temp_output_171_0_g3993 * _DirectionalGlowFadeNoiseScale ) ).r * _DirectionalGlowFadeNoiseFactor ) ) / max( _DirectionalGlowFadeWidth , 0.001 ) ) , 0.0 );
				float temp_output_161_0_g3993 = step( 0.1 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g3993 ) ):( temp_output_168_0_g3993 )) );
				float4 temp_output_1_0_g3993 = staticSwitch11_g3988;
				float clampResult154_g3993 = clamp( temp_output_161_0_g3993 , 0.0 , 1.0 );
				float4 appendResult3_g3993 = (float4(( ( (_DirectionalGlowFadeEdgeColor).rgb * ( temp_output_161_0_g3993 - step( 1.0 , (( _DirectionalGlowFadeInvert )?( ( 1.0 - temp_output_168_0_g3993 ) ):( temp_output_168_0_g3993 )) ) ) ) + (temp_output_1_0_g3993).rgb ) , ( temp_output_1_0_g3993.a * clampResult154_g3993 )));
				#ifdef _ENABLEDIRECTIONALGLOWFADE_ON
				float4 staticSwitch15_g3988 = appendResult3_g3993;
				#else
				float4 staticSwitch15_g3988 = staticSwitch11_g3988;
				#endif
				float4 temp_output_1_0_g4001 = staticSwitch15_g3988;
				float2 temp_output_126_0_g4001 = temp_output_18_0_g3988;
				float temp_output_121_0_g4001 = max( ( ( _HalftoneFade - distance( _HalftonePosition , temp_output_126_0_g4001 ) ) / max( 0.01 , _HalftoneFadeWidth ) ) , 0.0 );
				float2 appendResult11_g4002 = (float2(temp_output_121_0_g4001 , temp_output_121_0_g4001));
				float temp_output_17_0_g4002 = length( ( (( ( abs( temp_output_126_0_g4001 ) * _HalftoneTiling ) % float2( 1,1 ) )*2.0 + -1.0) / appendResult11_g4002 ) );
				float clampResult17_g4001 = clamp( saturate( ( ( 1.0 - temp_output_17_0_g4002 ) / fwidth( temp_output_17_0_g4002 ) ) ) , 0.0 , 1.0 );
				float4 appendResult3_g4001 = (float4((temp_output_1_0_g4001).rgb , ( temp_output_1_0_g4001.a * (( _HalftoneInvert )?( ( 1.0 - clampResult17_g4001 ) ):( clampResult17_g4001 )) )));
				#ifdef _ENABLEHALFTONE_ON
				float4 staticSwitch13_g3988 = appendResult3_g4001;
				#else
				float4 staticSwitch13_g3988 = staticSwitch15_g3988;
				#endif
				float4 temp_output_1_0_g4005 = staticSwitch13_g3988;
				float4 break2_g4007 = temp_output_1_0_g4005;
				float temp_output_9_0_g4006 = max( _AddColorContrast , 0.0 );
				float saferPower7_g4006 = max( ( ( ( break2_g4007.x + break2_g4007.y + break2_g4007.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4006 ) , 0.0 ) ) ) , 0.0001 );
				float4 appendResult6_g4005 = (float4(( ( (_AddColorColor).rgb * pow( saferPower7_g4006 , temp_output_9_0_g4006 ) * _AddColorFade ) + (temp_output_1_0_g4005).rgb ) , temp_output_1_0_g4005.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g4004 = appendResult6_g4005;
				#else
				float4 staticSwitch5_g4004 = staticSwitch13_g3988;
				#endif
				float4 temp_output_1_0_g4008 = staticSwitch5_g4004;
				float saferPower11_g4008 = max( ( 1.0 - temp_output_1_0_g4008.a ) , 0.0001 );
				float3 lerpResult4_g4008 = lerp( (temp_output_1_0_g4008).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g4008 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g4008.a ) ));
				float4 appendResult13_g4008 = (float4(lerpResult4_g4008 , temp_output_1_0_g4008.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g4004 = appendResult13_g4008;
				#else
				float4 staticSwitch11_g4004 = staticSwitch5_g4004;
				#endif
				float4 temp_output_1_0_g4009 = staticSwitch11_g4004;
				float4 break2_g4010 = temp_output_1_0_g4009;
				float temp_output_9_0_g4011 = max( _StrongTintContrast , 0.0 );
				float saferPower7_g4011 = max( ( ( ( break2_g4010.x + break2_g4010.y + break2_g4010.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4011 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult7_g4009 = lerp( (temp_output_1_0_g4009).rgb , ( pow( saferPower7_g4011 , temp_output_9_0_g4011 ) * (_StrongTintTint).rgb ) , _StrongTintFade);
				float4 appendResult9_g4009 = (float4(lerpResult7_g4009 , (temp_output_1_0_g4009).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g4004 = appendResult9_g4009;
				#else
				float4 staticSwitch7_g4004 = staticSwitch11_g4004;
				#endif
				float4 _White = float4(1,1,1,1);
				#ifdef _ENABLECUSTOMFADE_ON
				float4 staticSwitch8_g3899 = _White;
				#else
				float4 staticSwitch8_g3899 = IN.color;
				#endif
				#ifdef _ENABLESMOKE_ON
				float4 staticSwitch9_g3899 = _White;
				#else
				float4 staticSwitch9_g3899 = staticSwitch8_g3899;
				#endif
				float4 customVertexTint193 = staticSwitch9_g3899;
				float4 temp_output_119_0 = ( staticSwitch7_g4004 * customVertexTint193 );
				...
				float4 staticSwitch143 = temp_output_119_0;
				#endif
				float4 temp_output_1_0_g4016 = staticSwitch143;
				float4 appendResult5_g4016 = (float4(( (temp_output_1_0_g4016).rgb * temp_output_1_0_g4016.a ) , 1.0));
				
				fixed4 c = appendResult5_g4016;
				c.rgb *= c.a;
				return c;
			}
		ENDCG
...
/*ASEBEGIN
Version=18900
376;71;1414;737;-3635.426;-1211.152;1.921472;True;True
...
Node;AmplifyShaderEditor.FunctionNode;231;4899.456,2440.854;Inherit;False;_UberSpreadFade;-1;;3880;777ca8ab10170fb48b24b7cd1c44f075;0;7;27;FLOAT2;0,0;False;22;FLOAT;0;False;18;SAMPLER2D;0;False;25;FLOAT2;0,0;False;23;FLOAT2;0,0;False;21;FLOAT;0;False;26;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;256;2394.016,-2741.146;Inherit;False;237;shaderTime;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;223;4905.316,1828.167;Inherit;False;_UberDissolveFade;-1;;3882;cb957eb9b67f4f243aa8ba0547208263;0;5;21;FLOAT2;0,0;False;1;FLOAT;0;False;16;SAMPLER2D;0;False;18;FLOAT2;0,0;False;20;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;103;2715.721,-2556.586;Inherit;False;_GlitchUV;166;;3885;2addb21417fb5d745a5abfe02cbcd453;0;5;23;FLOAT;0;False;13;FLOAT2;0,0;False;22;SAMPLER2D;;False;3;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;257;3382.41,-2373.518;Inherit;False;_UberTransformUV;354;;3887;894b1de51a5f4c74cbe7828262f1344b;0;5;25;FLOAT;0;False;26;FLOAT2;0,0;False;1;FLOAT2;0,0;False;18;SAMPLER2D;0;False;3;SAMPLER2D;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;120;-737.796,35.8288;Inherit;False;_UberCustomAlpha;433;;3899;d68af6e3188f53845b23cf6e39df15fe;0;3;1;COLOR;0,0,0,0;False;6;SAMPLER2D;0;False;7;FLOAT2;0,0;False;2;COLOR;12;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;240;-683.451,-246.0232;Inherit;False;237;shaderTime;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;239;-404.7228,-125.1053;Inherit;False;_UberGenerated;418;;3904;52defa3f7cca25740a6a77f065edb382;0;4;10;FLOAT;0;False;8;SAMPLER2D;0;False;7;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;241;-136.8644,-329.1863;Inherit;False;_UberColor;39;;3908;db48f560e502b78409f7fbe481a93597;0;6;39;FLOAT;0;False;40;FLOAT2;0,0;False;1;FLOAT2;0,0;False;24;SAMPLER2D;0;False;3;COLOR;0,0,0,0;False;5;SAMPLER2D;0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;183;-37.83691,-91.99512;Inherit;False;182;hologramFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;51;183.7499,-168.0946;Inherit;False;_Hologram;140;;3943;76082a965d84d0e4da33b2cff51b3691;0;3;42;FLOAT;0;False;40;FLOAT;0;False;1;COLOR;1,1,1,1;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;104;973.7388,-316.5438;Inherit;False;_Glitch;160;;3946;97a01281f94bcc04fbb9a7c1cd328f08;0;5;34;FLOAT;0;False;31;FLOAT2;0,0;False;33;SAMPLER2D;;False;29;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;245;1656.25,-345.9998;Inherit;False;_UberEffect;171;;3950;93c7a07f758a0814998210619e8ad1cb;0;4;40;FLOAT;0;False;41;FLOAT2;0,0;False;3;COLOR;0,0,0,0;False;37;SAMPLER2D;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;78;2104.106,-267.8359;Inherit;False;AlphaMult;-1;;3986;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;76;3014.405,-219.2272;Inherit;False;AlphaMult;-1;;3987;d24974f7959982d48aab81e9e7692f35;0;2;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.FunctionNode;248;3912.165,-179.9706;Inherit;False;_UberFading;277;;3988;f8f5d1f402d6b694f9c47ef65b4ae91d;0;3;18;FLOAT2;0,0;False;1;COLOR;0,0,0,0;False;17;SAMPLER2D;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;413;;4003;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;117;4244.284,-85.79267;Inherit;False;_UberColorFinal;22;;4004;6ac57aba23ea6404ba71b6806ea93971;0;1;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4547.692,143.2021;Inherit;False;TintVertex;-1;;4012;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.StaticSwitch;198;4453.426,400.9801;Inherit;False;Property;_EnableSquish2;Enable Squish;412;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;9;1;FLOAT2;0,0;False;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT2;0,0;False;6;FLOAT2;0,0;False;7;FLOAT2;0,0;False;8;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.GetLocalVarNode;141;4826.724,532.0556;Inherit;False;123;fullFade;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;391;;4013;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;260;5434.385,76.11139;Inherit;False;_AdditiveAlpha;-1;;4016;cb954194b2fe72540b8ddbb6312b056a;0;1;1;COLOR;0,0,0,0;False;1;FLOAT4;0
...
ASEEND*/
//CHKSM=21A6516B142ABF64FBB6DDF5C2E2E6C485EB4C77