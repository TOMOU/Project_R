	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert( appdata_t IN  )
			{
				...
				float2 texCoord83_g4145 = IN.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 break77_g4145 = texCoord83_g4145;
				float2 appendResult72_g4145 = (float2(( _SquishStretch * ( break77_g4145.x - 0.5 ) * _SquishFade ) , ( _SquishFade * ( break77_g4145.y + _SquishFlip ) * -_SquishSquish )));
				#ifdef _ENABLESQUISH2_ON
				float2 staticSwitch198 = ( appendResult72_g4145 + _ZeroVector );
				#else
				float2 staticSwitch198 = _ZeroVector;
				#endif
				float2 temp_output_2_0_g4170 = staticSwitch198;
				...
				float temp_output_8_0_g4170 = shaderTime237;
				#ifdef _ENABLESINEMOVE_ON
				float2 staticSwitch4_g4170 = ( ( sin( ( temp_output_8_0_g4170 * _SineMoveFrequency ) ) * _SineMoveOffset * _SineMoveFade ) + temp_output_2_0_g4170 );
				#else
				float2 staticSwitch4_g4170 = temp_output_2_0_g4170;
				#endif
				float temp_output_30_0_g4172 = temp_output_8_0_g4170;
				float3 rotatedValue21_g4172 = RotateAroundAxis( float3( 0,0,0 ), float3( 0,1,0 ), float3( 0,0,1 ), ( temp_output_30_0_g4172 * _VibrateRotation ) );
				#ifdef _ENABLEVIBRATE_ON
				float2 staticSwitch6_g4170 = ( ( sin( ( _VibrateFrequency * temp_output_30_0_g4172 ) ) * _VibrateOffset * _VibrateFade * (rotatedValue21_g4172).xy ) + staticSwitch4_g4170 );
				#else
				float2 staticSwitch6_g4170 = staticSwitch4_g4170;
				#endif
				float2 temp_output_250_0 = staticSwitch6_g4170;
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				#endif
				float4 temp_output_1_0_g4162 = staticSwitch13_g4146;
				float4 break2_g4164 = temp_output_1_0_g4162;
				float temp_output_9_0_g4163 = max( _AddColorContrast , 0.0 );
				float saferPower7_g4163 = max( ( ( ( break2_g4164.x + break2_g4164.y + break2_g4164.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4163 ) , 0.0 ) ) ) , 0.0001 );
				float4 appendResult6_g4162 = (float4(( ( (_AddColorColor).rgb * pow( saferPower7_g4163 , temp_output_9_0_g4163 ) * _AddColorFade ) + (temp_output_1_0_g4162).rgb ) , temp_output_1_0_g4162.a));
				#ifdef _ENABLEADDCOLOR_ON
				float4 staticSwitch5_g4161 = appendResult6_g4162;
				#else
				float4 staticSwitch5_g4161 = staticSwitch13_g4146;
				#endif
				float4 temp_output_1_0_g4165 = staticSwitch5_g4161;
				float saferPower11_g4165 = max( ( 1.0 - temp_output_1_0_g4165.a ) , 0.0001 );
				float3 lerpResult4_g4165 = lerp( (temp_output_1_0_g4165).rgb , (_AlphaTintColor).rgb , ( pow( saferPower11_g4165 , _AlphaTintPower ) * _AlphaTintFade * step( _AlphaTintMinAlpha , temp_output_1_0_g4165.a ) ));
				float4 appendResult13_g4165 = (float4(lerpResult4_g4165 , temp_output_1_0_g4165.a));
				#ifdef _ENABLEALPHATINT_ON
				float4 staticSwitch11_g4161 = appendResult13_g4165;
				#else
				float4 staticSwitch11_g4161 = staticSwitch5_g4161;
				#endif
				float4 temp_output_1_0_g4166 = staticSwitch11_g4161;
				float4 break2_g4167 = temp_output_1_0_g4166;
				float temp_output_9_0_g4168 = max( _StrongTintContrast , 0.0 );
				float saferPower7_g4168 = max( ( ( ( break2_g4167.x + break2_g4167.y + break2_g4167.z ) / 3.0 ) + ( 0.1 * max( ( 1.0 - temp_output_9_0_g4168 ) , 0.0 ) ) ) , 0.0001 );
				float3 lerpResult7_g4166 = lerp( (temp_output_1_0_g4166).rgb , ( pow( saferPower7_g4168 , temp_output_9_0_g4168 ) * (_StrongTintTint).rgb ) , _StrongTintFade);
				float4 appendResult9_g4166 = (float4(lerpResult7_g4166 , (temp_output_1_0_g4166).a));
				#ifdef _ENABLESTRONGTINT_ON
				float4 staticSwitch7_g4161 = appendResult9_g4166;
				#else
				float4 staticSwitch7_g4161 = staticSwitch11_g4161;
				#endif
				...
				float4 temp_output_119_0 = ( staticSwitch7_g4161 * customVertexTint193 );
...
/*ASEBEGIN
Version=18900
159;138;1414;737;-3233.467;-1041.944;2.135912;True;True
...
Node;AmplifyShaderEditor.FunctionNode;199;4171.966,521.7499;Inherit;False;_Squish;414;;4145;6d6a73cc3433bad4186f7028cad3d98c;0;2;82;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;117;4244.284,-85.79267;Inherit;False;_UberColorFinal;23;;4161;6ac57aba23ea6404ba71b6806ea93971;0;1;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FunctionNode;250;4759.72,401.6135;Inherit;False;_UberTransformOffset;392;;4170;ee5e9e731457b2342bdb306bdb8d2401;0;2;8;FLOAT;0;False;2;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;195;4547.692,143.2021;Inherit;False;TintVertex;-1;;4169;b0b94dd27c0f3da49a89feecae766dcc;0;1;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=3420D2FAD111E606A1DC3A308C396905DE9EB790